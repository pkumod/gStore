...
class ISNode {
  ...
  virtual ISNode* getChild(int _index) const
  {
    return NULL;
  };
  virtual bool setChild(ISNode* _child, int _index)
  {
    return true;
  };
  virtual bool addChild(ISNode* _child, int _index)
  {
    return true;
  };
  ...
  virtual ISNode* getPrev() const
  {
    return NULL;
  };
  virtual ISNode* getNext() const
  {
    return NULL;
  };
  ...
  virtual bool setValue(char* _str, unsigned _len, int _index, bool ifcopy = false)
  {
    return true;
  };
  virtual bool addValue(char* _str, unsigned _len, int _index, bool ifcopy = false)
  {
    return true;
  };
