...
class Executor {
 ...
 public:
  ...
  std::tuple<bool,TableContentShardPtr> GenerateTableWithOneNode(const std::shared_ptr<std::vector<EdgeInfo>>& edge_info_vector,
  ...
  std::tuple<bool,TableContentShardPtr> InitialTableOneNode(const std::shared_ptr<FeedOneNode> one_step_join_node_,
                                                            bool is_entity,
                                                            bool is_literal,
                                                            bool is_predicate,
  ...
  std::tuple<bool,TableContentShardPtr> InitialTableTwoNode(const std::shared_ptr<FeedTwoNode> join_plan,
                                                            const PositionValueSharedPtr pos_id_mapping,
                                                            const IDCachesSharePtr id_caches);
  ...
  std::tuple<bool,TableContentShardPtr> ANodeEdgesConstraintFilter(const std::shared_ptr<FeedOneNode>&,
                                                                   TableContentShardPtr,
                                                                   const PositionValueSharedPtr&,
                                                                   const IDCachesSharePtr&);
