...
class Storage {
  ...
  //NOTICE:this is 1G(ok for most cases), use 2* if need more
  static const unsigned long long MAX_BUFFER_SIZE = Util::MAX_BUFFER_SIZE * 2; //max buffer size
  //static const unsigned SET_BUFFER_SIZE = 1 << 30;		//set buffer size
  static const unsigned HEAP_SIZE = MAX_BUFFER_SIZE / Node::INTL_SIZE;
  static const unsigned MAX_BLOCK_NUM = Util::MAX_BLOCK_NUM; //max block-num
