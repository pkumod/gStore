...
TARGET = $(exedir)gexport $(exedir)gbuild $(exedir)gserver $(exedir)gserver_backup_scheduler $(exedir)gquery \
		 ...
		 $(exedir)grestore $(exedir)gpara $(exedir)rollback
# TARGET = $(exedir)gbuild $(exedir)gdrop $(exedir)gquery $(exedir)ginit $(exedir)grpc
...
$(objdir)grpc.pb.o: GRPC/grpc.pb.cc GRPC/grpc.pb.h $(lib_antlr) $(lib_rpc)
	$(CXX) $(CFLAGS) GRPC/grpc.pb.cc $(inc) $(inc_log) $(inc_rpc) -o $(objdir)grpc.pb.o -DUSE_BOOST_REGEX $(def64IO) $(openmp)
