...
public:
  enum {
    ...
    K_INCREASE = 161, KK_INSERTDATA = 162, KK_DELETEDATA = 163, KK_DELETEWHERE = 164, 
    KK_ENCODE_FOR_URI = 165, KK_MD5 = 166, KK_SHA1 = 167, KK_SHA256 = 168, 
    KK_SHA384 = 169, KK_SHA512 = 170, KK_GROUP_CONCAT = 171, IRIREF = 172, 
    PNAME_NS = 173, PNAME_LN = 174, BLANK_NODE_LABEL = 175, VAR1 = 176, 
    VAR2 = 177, LANGTAG = 178, INTEGER = 179, DECIMAL = 180, DOUBLE = 181, 
    INTEGER_POSITIVE = 182, DECIMAL_POSITIVE = 183, DOUBLE_POSITIVE = 184, 
    INTEGER_NEGATIVE = 185, DECIMAL_NEGATIVE = 186, DOUBLE_NEGATIVE = 187, 
    EXPONENT = 188, STRING_LITERAL1 = 189, STRING_LITERAL2 = 190, STRING_LITERAL_LONG1 = 191, 
    STRING_LITERAL_LONG2 = 192, ECHAR = 193, NIL = 194, WS = 195, ANON = 196, 
    PN_CHARS_BASE = 197, PN_CHARS_U = 198, VARNAME = 199, PN_CHARS = 200, 
    PN_PREFIX = 201, PN_LOCAL = 202, PLX = 203, PERCENT = 204, HEX = 205, 
    PN_LOCAL_ESC = 206, COMMENT = 207
  };
