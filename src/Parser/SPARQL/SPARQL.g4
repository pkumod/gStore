...
|	K_CONTAINALL '(' expression ',' expression (',' expression)? ')' 
|	K_CONTAINANY '(' expression ',' expression (',' expression)? ')' 
...
|   K_CONFIDENCEDEGREE '(' numericLiteral ',' numericLiteral ',' numericLiteral ',' numericLiteral  ',' numericLiteral  ',' numericLiteral ')'
...
K_CONTAINALL : C O N T A I N A L L ;
K_CONTAINANY : C O N T A I N A N Y ;
...
K_CONFIDENCEDEGREE : C O N F I D E N C E D E G R E E ;
