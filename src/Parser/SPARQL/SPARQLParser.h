...
public:
  enum {
    ...
    K_DEGREECORRELATION = 164, K_INCREASE = 165, KK_INSERTDATA = 166, KK_DELETEDATA = 167, 
    KK_DELETEWHERE = 168, KK_ENCODE_FOR_URI = 169, KK_MD5 = 170, KK_SHA1 = 171, 
    KK_SHA256 = 172, KK_SHA384 = 173, KK_SHA512 = 174, KK_GROUP_CONCAT = 175, 
    IRIREF = 176, PNAME_NS = 177, PNAME_LN = 178, BLANK_NODE_LABEL = 179, 
    VAR1 = 180, VAR2 = 181, LANGTAG = 182, INTEGER = 183, DECIMAL = 184, 
    DOUBLE = 185, INTEGER_POSITIVE = 186, DECIMAL_POSITIVE = 187, DOUBLE_POSITIVE = 188, 
    INTEGER_NEGATIVE = 189, DECIMAL_NEGATIVE = 190, DOUBLE_NEGATIVE = 191, 
    EXPONENT = 192, STRING_LITERAL1 = 193, STRING_LITERAL2 = 194, STRING_LITERAL_LONG1 = 195, 
    STRING_LITERAL_LONG2 = 196, ECHAR = 197, NIL = 198, WS = 199, ANON = 200, 
    PN_CHARS_BASE = 201, PN_CHARS_U = 202, VARNAME = 203, PN_CHARS = 204, 
    PN_PREFIX = 205, PN_LOCAL = 206, PLX = 207, PERCENT = 208, HEX = 209, 
    PN_LOCAL_ESC = 210, COMMENT = 211
  };
