...
public:
  enum {
    ...
    K_SIMPLECYCLEPATH = 132, K_SIMPLECYCLEBOOLEAN = 133, K_CYCLEPATH = 134, 
    K_CYCLEBOOLEAN = 135, K_SHORTESTPATH = 136, K_SHORTESTPATHLEN = 137, 
    K_KHOPREACHABLE = 138, K_KHOPENUMERATE = 139, K_KHOPREACHABLEPATH = 140, 
    K_PPR = 141, K_TRIANGLECOUNTING = 142, K_CLOSENESSCENTRALITY = 143, 
    K_BFSCOUNT = 144, K_PR = 145, K_ALPHA = 146, K_MAXITER = 147, K_TOL = 148, 
    K_SSSP = 149, K_SSSPLEN = 150, K_LABELPROP = 151, K_WCC = 152, K_CLUSTERCOEFF = 153, 
    K_MAXIMUMKPLEX = 154, K_CORETRUSS = 155, K_PFN = 156, K_KHOPCOUNT = 157, 
    K_KHOPNEIGHBOR = 158, K_SHORTESTPATHCOUNT = 159, K_LOUVAIN = 160, K_IC14 = 161, 
    K_DIAMETERESTIMATION = 162, K_BETWEENNESSCENTRALITY = 163, K_JACCARDSIMILARITY = 164, 
    K_DEGREECORRELATION = 165, K_KHOPSHORTESTPATHS = 166, K_KHOPALLNEIGHBORS = 167, 
    K_INCREASE = 168, KK_INSERTDATA = 169, KK_DELETEDATA = 170, KK_DELETEWHERE = 171, 
    KK_ENCODE_FOR_URI = 172, KK_MD5 = 173, KK_SHA1 = 174, KK_SHA256 = 175, 
    KK_SHA384 = 176, KK_SHA512 = 177, KK_GROUP_CONCAT = 178, IRIREF = 179, 
    PNAME_NS = 180, PNAME_LN = 181, BLANK_NODE_LABEL = 182, VAR1 = 183, 
    VAR2 = 184, LANGTAG = 185, INTEGER = 186, DECIMAL = 187, DOUBLE = 188, 
    INTEGER_POSITIVE = 189, DECIMAL_POSITIVE = 190, DOUBLE_POSITIVE = 191, 
    INTEGER_NEGATIVE = 192, DECIMAL_NEGATIVE = 193, DOUBLE_NEGATIVE = 194, 
    EXPONENT = 195, STRING_LITERAL1 = 196, STRING_LITERAL2 = 197, STRING_LITERAL_LONG1 = 198, 
    STRING_LITERAL_LONG2 = 199, ECHAR = 200, NIL = 201, WS = 202, ANON = 203, 
    PN_CHARS_BASE = 204, PN_CHARS_U = 205, VARNAME = 206, PN_CHARS = 207, 
    PN_PREFIX = 208, PN_LOCAL = 209, PLX = 210, PERCENT = 211, HEX = 212, 
    PN_LOCAL_ESC = 213, COMMENT = 214
  };
