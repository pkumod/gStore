...
public:
  enum {
    ...
    K_KHOPNEIGHBOR = 157, K_SHORTESTPATHCOUNT = 158, K_LOUVAIN = 159, K_IC14 = 160, 
    K_DIAMETERESTIMATION = 161, K_BETWEENNESSCENTRALITY = 162, K_JACCARDSIMILARITY = 163, 
    K_DEGREECORRELATION = 164, K_KHOPSHORTESTPATHS = 165, K_KHOPALLNEIGHBORS = 166, 
    K_INCREASE = 167, KK_INSERTDATA = 168, KK_DELETEDATA = 169, KK_DELETEWHERE = 170, 
    KK_ENCODE_FOR_URI = 171, KK_MD5 = 172, KK_SHA1 = 173, KK_SHA256 = 174, 
    KK_SHA384 = 175, KK_SHA512 = 176, KK_GROUP_CONCAT = 177, IRIREF = 178, 
    PNAME_NS = 179, PNAME_LN = 180, BLANK_NODE_LABEL = 181, VAR1 = 182, 
    VAR2 = 183, LANGTAG = 184, INTEGER = 185, DECIMAL = 186, DOUBLE = 187, 
    INTEGER_POSITIVE = 188, DECIMAL_POSITIVE = 189, DOUBLE_POSITIVE = 190, 
    INTEGER_NEGATIVE = 191, DECIMAL_NEGATIVE = 192, DOUBLE_NEGATIVE = 193, 
    EXPONENT = 194, STRING_LITERAL1 = 195, STRING_LITERAL2 = 196, STRING_LITERAL_LONG1 = 197, 
    STRING_LITERAL_LONG2 = 198, ECHAR = 199, NIL = 200, WS = 201, ANON = 202, 
    PN_CHARS_BASE = 203, PN_CHARS_U = 204, VARNAME = 205, PN_CHARS = 206, 
    PN_PREFIX = 207, PN_LOCAL = 208, PLX = 209, PERCENT = 210, HEX = 211, 
    PN_LOCAL_ESC = 212, COMMENT = 213
  };
