...
public:
  enum {
    ...
    K_OFFSET = 97, K_CONTAINS = 98, K_SIMILARITY = 99, K_PREFIX = 100, K_MINUTES = 101, 
    K_REPLACE = 102, K_REGEX = 103, K_DELETE = 104, K_SEPARATOR = 105, K_DAY = 106, 
    K_SILENT = 107, K_STRLANG = 108, K_ORDER = 109, K_ROUND = 110, K_GRAPH = 111, 
    K_SECONDS = 112, K_URI = 113, K_DISTINCT = 114, K_EXISTS = 115, K_GROUP = 116, 
    K_SUM = 117, K_REDUCED = 118, K_FROM = 119, K_LANGMATCHES = 120, K_ISURI = 121, 
    K_TO = 122, K_ISIRI = 123, K_RAND = 124, K_STRDT = 125, K_COUNT = 126, 
    K_DESCRIBE = 127, K_VALUES = 128, K_LCASE = 129, K_OPTIONAL = 130, K_LIMIT = 131, 
    K_SUBSTR = 132, K_SIMPLECYCLEPATH = 133, K_SIMPLECYCLEBOOLEAN = 134, 
    K_CYCLEPATH = 135, K_CYCLEBOOLEAN = 136, K_SHORTESTPATH = 137, K_SHORTESTPATHLEN = 138, 
    K_KHOPREACHABLE = 139, K_KHOPENUMERATE = 140, K_KHOPREACHABLEPATH = 141, 
    K_PPR = 142, K_TRIANGLECOUNTING = 143, K_CLOSENESSCENTRALITY = 144, 
    K_BFSCOUNT = 145, K_PR = 146, K_ALPHA = 147, K_MAXITER = 148, K_TOL = 149, 
    K_SSSP = 150, K_SSSPLEN = 151, K_LABELPROP = 152, K_WCC = 153, K_CLUSTERCOEFF = 154, 
    K_MAXIMUMKPLEX = 155, K_CORETRUSS = 156, K_PFN = 157, K_KHOPCOUNT = 158, 
    K_KHOPNEIGHBOR = 159, K_SHORTESTPATHCOUNT = 160, K_LOUVAIN = 161, K_IC14 = 162, 
    K_DIAMETERESTIMATION = 163, K_BETWEENNESSCENTRALITY = 164, K_JACCARDSIMILARITY = 165, 
    K_DEGREECORRELATION = 166, K_KHOPSHORTESTPATHS = 167, K_KHOPALLNEIGHBORS = 168, 
    K_INCREASE = 169, KK_INSERTDATA = 170, KK_DELETEDATA = 171, KK_DELETEWHERE = 172, 
    KK_ENCODE_FOR_URI = 173, KK_MD5 = 174, KK_SHA1 = 175, KK_SHA256 = 176, 
    KK_SHA384 = 177, KK_SHA512 = 178, KK_GROUP_CONCAT = 179, IRIREF = 180, 
    PNAME_NS = 181, PNAME_LN = 182, BLANK_NODE_LABEL = 183, VAR1 = 184, 
    VAR2 = 185, LANGTAG = 186, INTEGER = 187, DECIMAL = 188, DOUBLE = 189, 
    INTEGER_POSITIVE = 190, DECIMAL_POSITIVE = 191, DOUBLE_POSITIVE = 192, 
    INTEGER_NEGATIVE = 193, DECIMAL_NEGATIVE = 194, DOUBLE_NEGATIVE = 195, 
    EXPONENT = 196, STRING_LITERAL1 = 197, STRING_LITERAL2 = 198, STRING_LITERAL_LONG1 = 199, 
    STRING_LITERAL_LONG2 = 200, ECHAR = 201, NIL = 202, WS = 203, ANON = 204, 
    PN_CHARS_BASE = 205, PN_CHARS_U = 206, VARNAME = 207, PN_CHARS = 208, 
    PN_PREFIX = 209, PN_LOCAL = 210, PLX = 211, PERCENT = 212, HEX = 213, 
    PN_LOCAL_ESC = 214, COMMENT = 215
  };
  ...
  public:
    ...
    antlr4::tree::TerminalNode *K_IC14();
    ...
    antlr4::tree::TerminalNode *K_KHOPSHORTESTPATHS();
