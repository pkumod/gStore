...
#ifndef _GRPC_STRINGPIECE_H
#define _GRPC_STRINGPIECE_H
...
//        }
    ...
    static StringPiece trim_pairs(const StringPiece &str, const char *pairs)
    {
...
template<> struct __type_traits<grpc::StringPiece> {
...
using StringPieceHash = StringPieceHashImpl<grpc::StringPiece>;

#endif // _GRPC_STRINGPIECE_H