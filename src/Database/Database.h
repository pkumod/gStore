...
public:
	...
	// build files
	bool build(const std::vector<std::string> &_rdf_files);
	bool encodeRDF_new(const std::vector<std::string> &_rdf_files, const string _error_log);
	bool sub2id_pre2id_obj2id_RDFintoSignature(const std::vector<std::string> &_rdf_files, const string _error_log, indicators::ProgressBar& bar, std::map<string, std::set<std::string>>& id_tuples);
...
private:
	...
	// bool sub2id_pre2id_obj2id_RDFintoSignature(const string _rdf_file, const string _error_log, indicators::ProgressBar& bar, std::map<string, std::set<std::string>>& id_tuples);
