...
public:
    ...
    void write_access_log(const string &operation, const string &remoteIP, const int statusCode, const string &statusMsg, const string &optId = "", unsigned num = 0, unsigned fail_num = 0);
