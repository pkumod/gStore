...
(For faster compiling speed, use `make -j4` instead, but this may not complete the compilation in some cases, please check whether executables exist in the `bin` directory or not)
