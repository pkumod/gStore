...
Trie::FindPrefixSet()
{
	...
	for (int i = 1; i < 32768 && (t.size() - i > 0); i++, it2--)
	{
		if (it2->first <= 0)
			break;
	...
	if ((save_size - total_pattern_size)*1.0 / totalsize < 0.3 )
	{
