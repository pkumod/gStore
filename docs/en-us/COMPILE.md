...
12. Any other questions, please go to [FAQ](/en-us/FAQ.md) page.
...
If you want to use API examples of gStore, please run `make APIexample` to compile example codes for both C++ API and Java API. For details of API, please visit [API](/en-us/API.md) chapter.
...
Type `make gtest` to compile the gtest program if you want to use this test utility. You can see the [HOW TO USE](/en-us/USAGE.md) for details of gtest program.
