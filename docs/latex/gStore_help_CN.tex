...
\hyperdef{}{chapter06}{\subsection{第06章：Hello World}\label{chapter06}}
...
在测试了DBpedia，LUBM和WatDiv benchmark 后，我们得出结论，新的B树比旧版本更高效。对于相同的三元组文件，新版本在执行gbuild指令上花费的时间更少。
